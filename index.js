...
// This is the main change: We are now ONLY allowing your Vercel frontend to make requests.
app.use(cors({
  origin: 'https://my-project-frontend-lyart.vercel.app'
}));
...
// --- Gemini API Configuration ---
// IMPORTANT: You should move this API key to an environment variable on Render for security.
const GEMINI_API_KEY = "AIzaSyBrf1bqYieVBq4jsyGyoJcRmYspH3aWT_c"; 
const GEMINI_API_URL = `https://generativelanguage.googleapis.com/v1beta/models/gemini-2.5-flash-preview-05-20:generateContent?key=${GEMINI_API_KEY}`;
const TTS_API_URL = `https://generativelanguage.googleapis.com/v1beta/models/gemini-2.5-flash-preview-tts:generateContent?key=${GEMINI_API_KEY}`;
